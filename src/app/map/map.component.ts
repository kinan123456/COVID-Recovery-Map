import { Component, OnInit, NgZone, DoCheck, ChangeDetectorRef, AfterViewInit } from '@angular/core';
import { CountryService } from '../country/country.service';
import { Country } from '../country/country.model';
import { DistanceLegendService } from '../distance-scale/distance-legend.service';
...
const DEFAULT_ZOOM_AMOUNT = 200000;
...
export class MapComponent implements OnInit {
  ...
  constructor(private countrySvc: CountryService,
    private ngZone: NgZone, private distanceSvc: DistanceLegendService) { }
  ...
  ngOnInit() {
    this.ngZone.runOutsideAngular(() => {
      ...
      viewer.camera.changed.addEventListener(function() {
        that.distanceSvc.updateDistanceLegendCesium(viewer);
      });
      this.flyToCountry();
    });
  }
